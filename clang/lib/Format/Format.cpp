...
FormatStyle getXenStyle() {
  ...
  XenStyle.AlwaysBreakTemplateDeclarations = true;
  XenStyle.BinPackArguments = false;
  XenStyle.BinPackParameters = false;
  XenStyle.BraceWrapping = {true, true, true, true, true, true,
                            true, true, true, true, false, true,
                            true,  true};
  XenStyle.BreakBeforeBraces = FormatStyle::BS_Custom;
  ...
  XenStyle.SpaceAfterCStyleCast = false;
  XenStyle.SpacesInCStyleCastParentheses = true;
  XenStyle.SpacesInParentheses = true;
  XenStyle.TabWidth = 4;
  return XenStyle;
}
